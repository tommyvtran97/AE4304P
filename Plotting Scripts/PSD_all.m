figure(25)
subplot(211)
loglog(w, Sana_u(:,1), '-', omega, Sfft_u(:,1),w_p, Spw_u(:,1),'linewidth',1);
axis(10.^[-2,2,-15,0]);
...
grid on
subplot(212)
loglog(w, Sana_c(:,1), '-', omega, Sfft_c(:,1),w_p, Spw_c(:,1),'linewidth',1);
axis(10.^[-2,2,-15,0]);
xlabel('$\omega$ [$\frac{rad}{s}$]','interpreter','latex','FontSize', 25); 
ylabel('$S_{uu}$ [$\frac{rad^2}{rad/s}$]','interpreter','latex','FontSize', 25);  
...
figure(26)
subplot(211)
loglog(w, Sana_u(:,2), '-', omega, Sfft_u(:,2),w_p, Spw_u(:,2),'linewidth',1);
axis(10.^[-2,2,-15,0]);
xlabel('$\omega$ [$\frac{rad}{s}$]','interpreter','latex','FontSize', 25); 
...
grid on
subplot(212)
loglog(w, Sana_c(:,2), '-', omega, Sfft_c(:,2),w_p, Spw_c(:,2),'linewidth',1);
axis(10.^[-2,2,-15,0]);
xlabel('$\omega$ [$\frac{rad}{s}$]','interpreter','latex','FontSize', 25); 
ylabel('$S_{\alpha\alpha}$ [$\frac{rad^2}{rad/s}$]','interpreter','latex','FontSize', 25);
title('Power spectral density with pitch damper');
...
figure(27)
subplot(211)
loglog(w, Sana_u(:,3), '-', omega, Sfft_u(:,3),w_p, Spw_u(:,3),'linewidth',1);
axis(10.^[-2,2,-15,0]);
xlabel('$\omega$ [$\frac{rad}{s}$]','interpreter','latex','FontSize', 25);
...
grid on
subplot(212)
loglog(w, Sana_c(:,3), '-', omega, Sfft_c(:,3),w_p, Spw_c(:,3),'linewidth',1);
axis(10.^[-2,2,-15,0]);
xlabel('$\omega$ [$\frac{rad}{s}$]','interpreter','latex','FontSize', 25);
ylabel('$S_{\theta\theta}$ [$\frac{rad^2}{rad/s}$]','interpreter','latex','FontSize', 25);
title('Power spectral density with pitch damper');
...
figure(28)
subplot(211)
loglog(w, Sana_u(:,4), '-', omega, Sfft_u(:,4),w_p, Spw_u(:,4),'linewidth',1);
axis(10.^[-2,2,-15,0]);
xlabel('$\omega$ [$\frac{rad}{s}$]','interpreter','latex','FontSize', 25); 
...
grid on
subplot(212)
loglog(w, Sana_c(:,4), '-', omega, Sfft_c(:,4),w_p, Spw_c(:,4),'linewidth',1);
axis(10.^[-2,2,-15,0]);
xlabel('$\omega$ [$\frac{rad}{s}$]','interpreter','latex','FontSize', 25); 
ylabel('$S_{qq}$ [$\frac{rad^2}{rad/s}$]','interpreter','latex','FontSize', 25); 
title('Power spectral density with pitch damper');
...
figure(29)
subplot(211)
loglog(w, Sana_u(:,5), '-', omega, Sfft_u(:,5),w_p, Spw_u(:,5),'linewidth',1);
axis(10.^[-2,2,-15,0]);
xlabel('$\omega$ [$\frac{rad}{s}$]','interpreter','latex','FontSize', 25);
...
grid on
subplot(212)
loglog(w, Sana_c(:,5), '-', omega, Sfft_c(:,5),w_p, Spw_c(:,5),'linewidth',1);
axis(10.^[-2,2,-15,0]);
xlabel('$\omega$ [$\frac{rad}{s}$]','interpreter','latex','FontSize', 25);
ylabel('$S_{n_zn_z}$ [$\frac{rad^2}{rad/s}$]','interpreter','latex','FontSize', 25); 
title('Power spectral density with pitch damper');
